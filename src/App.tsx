        ...
        <AnimatePresence mode="wait" initial>
          ...
          >
            {/*
              ...
              The /connect-wallet route lazy-loads its own WalletProviders
              wrapper (see src/views/ConnectWalletViewLazyShell.tsx) so the
              wagmi/RainbowKit/Mezo Passport stack stays out of the root chunk.
            */}
